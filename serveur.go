...
func main() {
	...
	http.HandleFunc("/Groupie-tracker/cart", cart)
...
func cart(w http.ResponseWriter, r *http.Request) {
	...
	page := 1
	data, err := ArtistPage(lien+"/artists", page)                                                                                                                                                                                            //récupération des donnée a envoyer sur la page html
	tmpl, err := template.ParseFiles("./templates/home.html", "./templates/navbar.html", "./templates/footer.html", "./templates/pageaccueil.html", "./templates/pagelistartists.html", "./templates/pagecart.html", "./templates/cart.html") // utilisation du fichier navPage.gohtml pour le template
	if err != nil {
		fmt.Println(err)
		tmpl, err = template.ParseFiles("./templates/Error500.gohtml") //utilisation du fichier Error500.gohtml pour le template
		print(err)
	...
	// 	return
	// }
	tmpl.ExecuteTemplate(w, "cart", data) //exécution du template
}
