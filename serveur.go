...
func main() {
	...
	http.HandleFunc("/Groupie-tracker", func(w http.ResponseWriter, r *http.Request) {
		...
		tmpl, err := template.ParseFiles("./templates/home.html", "./templates/artist.html", "./templates/navbar.html", "./templates/footer.html", "./templates/pageaccueil.html", "./templates/pagelistartists.html") // utilisation du fichier navPage.gohtml pour le template
		if err != nil {
	...
	http.HandleFunc("/Groupie-tracker/listartist", func(w http.ResponseWriter, r *http.Request) {
		...
		tmpl, err := template.ParseFiles("./templates/home.html", "./templates/artist.html", "./templates/navbar.html", "./templates/footer.html", "./templates/pageaccueil.html", "./templates/pagelistartists.html") // utilisation du fichier navPage.gohtml pour le template // utilisation du fichier navPage.gohtml pour le template
		if err != nil {
			fmt.Println(err, "/")
