...
func home(w http.ResponseWriter, r *http.Request) {
	tmpl, _ := template.ParseFiles("templates/base.tmpl", "templates/artists.tmpl")
...
// 		if r.Method == "GET" {
// 			tmpl, err = template.ParseFiles("templates/base.html", "templates/artists.html")
// 			nb, _ = strconv.Atoi(r.FormValue("nombre"))
// 		}
// 		data, codeError := get(lien+"/artists", nb)
// 		if codeError == 500 {
// 		}
// 		tmpl.ExecuteTemplate(w, "Groupie-tracker/artist", data)
// 	})
